...
<nav style="background-color: #000!important; position: fixed; width: 100%; z-index: 1;" class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="home">SHOESEL</a>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
            ...
            <form action="search" method="post" class="form-inline my-2 my-lg-0">
                ...
                <a class="btn btn-success btn-sm ml-3" href="show">
                    ...
                    <span class="badge badge-light">${show.totalAmount}</span>
                </a>
            </form>
        </div>
    </div>
...
<section class="jumbotron text-center">
    <div style="margin-top: 100px"class="container">
        <h1 style="color:000;"class="jumbotron-heading">Chiết tiết sản phẩm</h1>
        <p style="color:#000!important;"class="lead text-muted mb-0">Uy tín tạo nên thương hiệu với hơn 10 năm cung cấp các sản phầm giày nhập từ Việt Nam</p>
    </div>
</section>