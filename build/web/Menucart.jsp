...
<section class="jumbotron text-center">
    <div style="margin-top: 100px"class="container">
        <h1 style="color:#000;"class="jumbotron-heading">Giỏ hàng của bạn</h1>
        <p style="color:#000!important;"class="lead text-muted mb-0">Hãy trải nghiệm các sản phẩm tuyệt vời tại Shoesel</p>
    </div>
</section>