                    ...
                    <div class="container">
                        <div class="card">
                            <div class="row">
                                ...
                                <aside style ="position: relative;" class="col-sm-7">
                                    <article class="card-body p-5">
                                        ...
                                        <hr>
                                        <a href="order?pcid=${detail.pid}" class="btn btn-lg btn-primary text-uppercase"> Buy now </a>
                                        <a href="order?pcid=${detail.pid}" class="btn btn-lg btn-outline-primary text-uppercase"> <i class="fas fa-shopping-cart"></i> Add to cart </a>
                                    </article> <!-- card-body.// -->
